...
if (isset($_POST['submit'])) {
    ...
    $err = "Please enter your name";
        ...
        $err = "Phone number must contain only numbers or a leading + sign";
    ...
    if ($password != $confirmPassword) {
        ...
        $checkEmail = "SELECT id FROM customers WHERE email = '$email' LIMIT 1";
        ...
        if ($emailResult->num_rows > 0) {
            ...
            $sql = "INSERT INTO customers (name,email, phone, password, is_verified) 
            VALUES ('$name', '$email', '$phone', '$hash_pass', 'Not Verified')";


            if ($db->query($sql) === true) {
                $msg = 'Registration has been successful, Please login';
                $name = $email = $phone = '';
            } else {
                        ...
                        <div class="card-body">
                            ...
                            <form id="formLogin" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-label-group">
                                        <!-- Usually we do NOT refill passwords for security -->
